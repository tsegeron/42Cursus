...
void ft_square(char **strs, int dl, int dlina, char fr, char ob)
{
    int **tab;
    int *tabl;
    int i;
...
void ft_square_max(int **tab, int y, int x)
{
    int i;
    int j;
...
void ft_find_max(int **tab, int y, int x)
{
    int max;
    int i;
    int j;
...
void ft_find_max_ij(int **tab, int y, int x, int max)
{
    int i;
    int j;
...
/* char **strs, int is, int js, char sq */
