...
/*   Updated: 2021/12/10 06:34:59 by gernesto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
int	*merge_sort(int *a, size_t end)
{
	int *left_array;
	int *right_array;
	...
	if (end < 2)
		return a;
	left_array = copy_array(a, 0, end / 2);
	for (int i = 0; i < end/2; i++)
		printf("left   : %d > %d\n",i, left_array[i]);

	right_array = copy_array(a, end / 2, end);
	for (int i = 0; i < end/2; i++)
		printf("right  : %d\n", right_array[i]);
	left_array = merge_sort(left_array, end/2);
	right_array = merge_sort(right_array, end/2);
